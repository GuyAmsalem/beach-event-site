...
דף HTML אינטרקטיבי בעברית (RTL) לערב בים: צ'קליסטים לציוד הקמה, רשימת קניות משותפת וציוד אישי.
...
- ברשימות המשותפות (ציוד הקמה + קניות), סימון פריט מתעד בקטן מי סימן אותו ("סומן ע"י &lt;שם&gt;"); ביטול הסימון מסיר את התיעוד.
